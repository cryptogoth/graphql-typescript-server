...
export const init_db = async() => {
  ...
  // 6 pokemon
  // each one can have 2^6 combinations of abilities
  // (ability 1: present, or not) * (ability 2: present, or not) ... (ability 6: )

  // Relation is a table, that relates rows of two other tables
  // How many possible Abilities tables can we have? (relation between Pokemon and Abilities) = 6 * 2^6 different tables

  // = 6 * 2^6 = 384 different tables
